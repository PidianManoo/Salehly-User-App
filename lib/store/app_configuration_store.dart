...
abstract class _AppConfigurationStore with Store {
  ...
  int platFormCommissionEarningPercentage =
      getIntAsync(PLAT_FORM_COMMISSION_EARNING_PERCENTAGE);
  ...
  @action
  Future<void> setPlatFormCommissionEarning(int val) async {
    platFormCommissionEarningPercentage = val;
    await setValue(PLAT_FORM_COMMISSION_EARNING_PERCENTAGE, val);
  }
}
