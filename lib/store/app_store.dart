...
abstract class _AppStore with Store {
  ...
  @observable
  bool isUserAppForceUpdate = false;

  @observable
  bool isProviderAppForceUpdate = false;
  ...
  @action
  Future<void> setUserAppForceUpdate(bool val,
      {bool isInitializing = false}) async {
    isUserAppForceUpdate = val;
    if (!isInitializing) await setValue(IS_USER_APP_FORCE_UPDATE, val);
  }

  @action
  Future<void> setProviderAppForceUpdate(bool val,
      {bool isInitializing = false}) async {
    isProviderAppForceUpdate = val;
    if (!isInitializing) await setValue(IS_PROVIDER_APP_FORCE_UPDATE, val);
  }
