...
mixin _$AppConfigurationStore on _AppConfigurationStore, Store {
  ...
  late final _$platFormCommissionEarningPercentageAtom = Atom(
      name: '_AppConfigurationStore.platFormCommissionEarningPercentage',
      context: context);

  @override
  int get platFormCommissionEarningPercentage {
    _$platFormCommissionEarningPercentageAtom.reportRead();
    return super.platFormCommissionEarningPercentage;
  }

  @override
  set platFormCommissionEarningPercentage(int value) {
    _$platFormCommissionEarningPercentageAtom
        .reportWrite(value, super.platFormCommissionEarningPercentage, () {
      super.platFormCommissionEarningPercentage = value;
    });
  }
  ...
  late final _$setPlatFormCommissionEarningAsyncAction = AsyncAction(
      '_AppConfigurationStore.setPlatFormCommissionEarning',
      context: context);

  @override
  Future<void> setPlatFormCommissionEarning(int val) {
    return _$setPlatFormCommissionEarningAsyncAction
        .run(() => super.setPlatFormCommissionEarning(val));
  }
...
platFormCommissionEarningPercentage: ${platFormCommissionEarningPercentage}
    ''';
  }
}
