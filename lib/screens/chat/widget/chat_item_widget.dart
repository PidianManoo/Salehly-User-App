...
import 'offer_message_widget.dart';
    ...
    Widget chatItem(String messageTypes) {
      return messageTypes == MessageType.TEXT.name
          ...
          : messageTypes == MessageType.Files.name
              ...
              : messageTypes == MessageType.offer.name
                  ? OfferMessageWidget(
                      chatItemData: widget.chatItemData,
                      time: time,
                    )
                  : Offstage();
    }
    ...
    return GestureDetector(
      ...
      child: Container(
        child: Column(
          ...
          children: [
            widget.chatItemData.messageType == MessageType.offer.name
                ? chatItem(widget.chatItemData.messageType ?? "")
                : Container(
