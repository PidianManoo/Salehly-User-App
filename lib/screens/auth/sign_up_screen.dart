                ...
                validator: (val) {
                  if (val == null || val.isEmpty) {
                    ...
                    return language.passwordLengthShouldBe;
                          ...
                          r'^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[!@#\$&*~]).{8,}$')
                      .hasMatch(val)) {
                    return language.passwordValidationMessage;
                  }
                  return null;
                },
                onFieldSubmitted: (s) {},
                    ...
                    children: [
                      if (cur.flag.validate().isNotEmpty)
                        ClipRRect(
                          ...
                          child: Image.asset(cur.flag.validate(), height: 16, width: 24, fit: BoxFit.cover),
                        )
                      else
                        Icon(Icons.language, color: context.iconColor, size: 18),
                      const SizedBox(width: 6),
                      Text(
                        cur.languageCode!.toUpperCase(),
                        style: boldTextStyle(size: 12, color: context.iconColor),
                      ),
                    ],
                  ),
                ),
