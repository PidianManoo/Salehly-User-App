...
class OTPLoginScreen extends StatefulWidget {
  ...
  final Country? selectedCountryData;
...
class _OTPLoginScreenState extends State<OTPLoginScreen> {
  ...
  void initState() {
    ...
    if (widget.isFromSignin) {
      numberController.text = widget.phoneNumber.validate();
      isCodeSent = true;
      verificationId = widget.verificationId.validate();
      selectedCountry = widget.selectedCountryData ?? defaultCountry();
    }
    ...
    if (isCodeSent) {
      return Padding(
        ...
        child: Column(
          ...
          children: [
            Text(language.enterTheCodeSentToYou,
                style: boldTextStyle(size: 24)),
            8.height,
            Text(
              '${language.confirmationCodeHasBeenSentTo} +${selectedCountry.phoneCode} ${numberController.text}',
