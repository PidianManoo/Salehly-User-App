...
class _BookPostJobRequestScreenState extends State<BookPostJobRequestScreen> {
  ...
  void bookServices() {
    ...
    num totalPlatFormCommission =
        widget.postJobDetailResponse.postRequestDetail!.jobPrice.validate() *
            appConfigurationStore.platFormCommissionEarningPercentage /
            100;
    ...
    Map request = {
      ...
      BookService.amount:
          widget.postJobDetailResponse.postRequestDetail!.jobPrice.validate(),
      BookingServiceKeys.totalAmount: totalPlatFormCommission.validate() +
          widget.postJobDetailResponse.postRequestDetail!.jobPrice.validate(),
      ...
      BookService.totalPlatformCommissionAmount: totalPlatFormCommission,
    };
