...
class DashboardResponse {
  ...
  List<CategoryData>? featuredCategory;
  ...
  factory DashboardResponse.fromJson(Map<String, dynamic> json) {
    return DashboardResponse(
      ...
      featuredCategory: json['featured_categories'] != null ? (json['featured_categories'] as List).map((i) => CategoryData.fromJson(i)).toList() : null,
