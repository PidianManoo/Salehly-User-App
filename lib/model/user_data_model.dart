...
class UserData {
  ...
  factory UserData.fromJson(Map<String, dynamic> json) {
    return UserData(
      ...
      totalCompletedJobs: json['total_completed_jobs'] != null
          ? json['total_completed_jobs'].toString().toInt()
          : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.totalCompletedJobs != null) data['total_completed_jobs'] = this.totalCompletedJobs;
