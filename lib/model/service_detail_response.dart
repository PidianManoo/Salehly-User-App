...
class ServiceDetailResponse {
  ...
  num? platformCommissionEarningPercentage;
  num? vatPercentage;
  ...
  ServiceDetailResponse({
    ...
    this.serviceFaq,
    this.serviceaddon,
    this.platformCommissionEarningPercentage,
    this.vatPercentage,
  });
  ...
  factory ServiceDetailResponse.fromJson(Map<String, dynamic> json) {
    return ServiceDetailResponse(
      ...
      platformCommissionEarningPercentage: json['platform_commission_earning_percentage'],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['platform_commission_earning_percentage'] = this.platformCommissionEarningPercentage;
