  ...
  factory UserWalletHistoryResponse.fromJson(Map<String, dynamic> json) {
    return UserWalletHistoryResponse(
      ...
      data: json['data'] is List
          ? List<WalletDataElement>.from(
              json['data'].map((x) => WalletDataElement.fromJson(x)))
          : [],
      availableBalance:
...
class WalletDataElement {
  ...
  factory WalletDataElement.fromJson(Map<String, dynamic> json) {
    return WalletDataElement(
      ...
      activityType:
          json['activity_type'] is String ? json['activity_type'] : "",
      activityMessage:
          json['activity_message'] is String ? json['activity_message'] : "",
...
class ActivityData {
  ...
  factory ActivityData.fromJson(Map<String, dynamic> json) {
    return ActivityData(
      ...
      creditDebitAmount:
          json['credit_debit_amount'] is num ? json['credit_debit_amount'] : 0,
