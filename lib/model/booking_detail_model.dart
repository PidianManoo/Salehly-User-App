...
class BookingDetailResponse {
  ...
  factory BookingDetailResponse.fromJson(Map<String, dynamic> json) {
    return BookingDetailResponse(
      ...
      postRequestDetail: json['post_request_detail'] != null
          ...
          : null,
      hasRefundRequest: json['has_refund_request'],
      refundRequest: json['refund_request'] != null
          ? RefundRequestData.fromJson(json['refund_request'])
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['has_refund_request'] = this.hasRefundRequest;
    if (this.refundRequest != null) {
      data['refund_request'] = this.refundRequest!.toJson();
    }
    return data;
  }
}
