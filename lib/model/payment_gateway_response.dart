...
class PaymentSetting {
  ...
  PaymentSetting.fromJson(Map<String, dynamic> json)
      : id = json["id"],
        ...
        status = json["status"],
        isTest = json["is_test"],
        testValue = json['value'] is Map ? LiveValue.fromJson(json['value']) : LiveValue(),
        liveValue = json['live_value'] is Map ? LiveValue.fromJson(json['live_value']) : LiveValue();
...
class LiveValue {
  ...
  factory LiveValue.fromJson(Map<String, dynamic> json) {
    return LiveValue(
      ...
      fatoorahUrl: json['fatoorah_url'] ?? '',
      fatoorahKey: json['fatoorah_key'] ?? '',
      moyasarUrl: json['moyasar_url'] ?? '',
  ...
  Map<String, dynamic> toJson() {
    ...
    data['fatoorah_url'] = this.fatoorahUrl;
    data['fatoorah_key'] = this.fatoorahKey;
    data['moyasar_url'] = this.moyasarUrl;
    data['moyasar_key'] = this.moyasarKey;
