...
class BookingData {
  ...
  num? finalTotalTax;
  num? totalPlatformCommissionAmount;
  num? finalSubTotal;
  ...
  String? cancellationChargeAmount;
  num? refundAmount;
  String? refundStatus;
  ...
  BookingData({
    ...
    this.finalTotalTax,
    this.totalPlatformCommissionAmount,
    this.finalSubTotal,
    this.finalDiscountAmount,
    this.finalCouponDiscountAmount,
    this.vatPercentage,
    this.vatAmount,
    this.platformCommissionPercentage,
    this.txnId,
    this.serviceaddon,
    this.bookingDate,
  ...
  factory BookingData.fromJson(Map<String, dynamic> json) {
    return BookingData(
      ...
      cancellationChargeAmount: json['cancellation_charge_amount']?.toString(),
      refundAmount: json['refund_amount'],
      refundStatus: json['refund_status'],
      totalPlatformCommissionAmount: json['total_platform_commission_amount'],
      isUrgentBooking: json['IsUrgentbooking']
          ?? json['post_request_detail']?['IsUrgentbooking'],
      urgentBookingTime: json['urgentBookingTime']
          ?? json['post_request_detail']?['urgentBookingTime'],
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['platform_commission_percentage'] = this.platformCommissionPercentage;
    ...
    data['total_platform_commission_amount'] = this.totalPlatformCommissionAmount;
    return data;
  }
}
