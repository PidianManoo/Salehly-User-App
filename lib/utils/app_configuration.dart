...
Future<void> setAppConfigurations(AppConfigurationModel data) async {
  ...
  await appStore.setUserAppForceUpdate(data.isUserAppForceUpdate.validate());
  await appStore
      .setProviderAppForceUpdate(data.isProviderAppForceUpdate.validate());

  await appConfigurationStore.setCurrencyCode(data.currencyCode.validate());
  await appConfigurationStore.setPlatFormCommissionEarning(
      data.platformCommissionEarningPercentage.validate());
...
const PLAT_FORM_COMMISSION_EARNING_PERCENTAGE =
    'PLAT_FORM_COMMISSION_EARNING_PERCENTAGE';
...
class AppConfigurationModel {
  ...
  String? distanceType;
  String? radius;
  int? platformCommissionEarningPercentage;
  ...
  bool isUserAppForceUpdate;
  bool isProviderAppForceUpdate;
  ...
  AppConfigurationModel.fromJsonMap(Map<String, dynamic> map)
      : siteName = map["site_name"],
        ...
        radius = map["radius"],
        platformCommissionEarningPercentage =
            map["platform_commission_earning_percentage"],
        ...
        promotional_banner = map["promotional_banner"] ?? false,
        roleAndPermission = map["role_and_permission"] is Map
            ? RolesAndPermissionModel.fromJsonMap(map["role_and_permission"])
            : null,
        isUserAppForceUpdate = map["is_user_app_force_update"] ?? false,
        isProviderAppForceUpdate = map["is_provider_app_force_update"] ?? false;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['radius'] = radius;
    data['platform_commission_earning_percentage'] =
        platformCommissionEarningPercentage;
    ...
    data['is_user_app_force_update'] = isUserAppForceUpdate;
    data['is_provider_app_force_update'] = isProviderAppForceUpdate;
    return data;
  }
}
//endregion
