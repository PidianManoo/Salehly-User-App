...
class BookService {
  ...
  static String totalPlatformCommissionAmount =
      'total_platform_commission_amount';
}
...
class PostJob {
  ...
  static String latitude = 'latitude';
  static String longitude = 'longitude';
  static String rejectionReason = 'rejection_reason';
  static String bidStatus = 'bid_status';

  static String counterOfferPrice = 'counter_offer_price';
  static String acceptedByProvider = 'accepted_by_provider';
}
