...
var appPackageName = isAndroid ? 'com.salehly.user' : 'com.salehly.user';
...
//region Saudi Arabia currency symbol font style
const SAUDI_ARABIA_CURRENCY_SYMBOL_FONT_STYLE = 'Untitled2';
...
const double CATEGORY_ICON_SIZE = 80;
...
const IS_USER_APP_FORCE_UPDATE = 'IS_USER_APP_FORCE_UPDATE';
const IS_PROVIDER_APP_FORCE_UPDATE = 'IS_PROVIDER_APP_FORCE_UPDATE';
...
const PAYMENT_METHOD_MYFATOORAH = 'fatoorah';
const PAYMENT_METHOD_MOYASAR = 'moyasar';
...
const JOB_REQUEST_STATUS_REJECTED = "Rejected";
const JOB_REQUEST_PENDING = "pending";
const JOB_REQUEST_ACCEPTED_BY_CUSTOMER = "accepted_by_customer";
const counterOfferByCustomer = "counter_offer_by_customer";
const JOB_REQUEST_REJECTED_BY_CUSTOMER = "rejected_by_customer";
const JOB_REQUEST_REJECTED_BY_PROVIDER = "rejected_by_provider";
const JOB_REQUEST_ACCEPTED_BY_PROVIDER = "accepted_by_provider";
const JOB_REQUEST_CONFIRMED = "confirmed";
// endregion
